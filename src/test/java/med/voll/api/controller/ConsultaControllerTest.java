...
class ConsultaControllerTest {
    ...
    @Autowired
    private MockMvc mockMvc; // llama directamente a nuestro controller
    ...
    @Test
    @DisplayName("Deberia devolver un metodo HTTP 400 cuando la request no tenga datos")
    @WithMockUser
    ...
    @Test
    @DisplayName("Deberia devolver un metodo HTTP 200 cuando se reciba un JSON valido")
    @WithMockUser
